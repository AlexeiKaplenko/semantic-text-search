...
def analyze_sequence(sequence, query):
    ...
    url = "https://zeu90cba02.execute-api.eu-central-1.amazonaws.com/zero-shot-classification-3-pytorchEndpoint-B0UPVS3RAF1C" # Lambda 3

    # url = "https://pprvz8rt3h.execute-api.eu-central-1.amazonaws.com/zero-shot-classification-6" # Lambda 6
                ...
                for i in range(len(output)):
                    ...
                    if out_dict['probability'] != None:
                        ...
                        if float(out_dict['probability']) >= confidence_threshold:
                            st.write(sequences[i], '(confidence:', out_dict['probability'][:4],')')  
